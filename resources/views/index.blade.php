										...
										<div class="row">
											<div class='col-6'>
												<ul class="nav navbar-nav">	
													<li><a href="/create">Create New Wedding Hall</a></li>
											</div>
											<div class="col-6">
											<div class="input-group">
											<input type="text" class="form-control" value="Search Wedding Hall In" aria-label="Text input with dropdown button" disabled>
											<div class="input-group-append">
												<button class="btn btn btn-outline-light dropdown-toggle" type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> City </button>
												<div class="dropdown-menu">
													@foreach ($loc_data as $data)
													<a class="dropdown-item" href="/towns/{{$data->id}}">{{$data->city}}</a>
													@endforeach
												</div>
											</div>
											</div>
				...
				<div class="container">
					<div class="banner-address">
						<div class="col-md-4 banner-address-left">
							<p><i class="fa fa-map-marker" aria-hidden="true"></i> 648 C-BLOCK FAISAL TOWN, LAHORE.</p>
						</div>
						<div class="col-md-4 banner-address-left">
